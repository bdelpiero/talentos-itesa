...
console.log(project,"proyecto nombre");
  ...
  return (  
    <>  
     ...
     { item == 1  && <span className='span-title'>
          <Title level={2} className='header-title'>Dashboard</Title>
          <Text>Bienvenido a Itesa, {currentUser.name + ' ' + ':)' }
          </Text>
        </span>}
         { item == 2 && 
         <span className='span-title'>
          <Title level={2} className='header-title'>Todos los Proyectos</Title>
          <Text>{"Proyectos Itesa :)"}
          </Text>
        </span>}  
        { item == 3 && 
         <span className='span-title'>
          <Title level={2} className='header-title'>Proyecto {project.name}</Title>
          <Text>{"Proyectos Itesa :)"}
          </Text>
        </span>}  
    ...
    <Header className='header-user'>
     ...
     { item == 1  && <span className='span-title'>
        ...
        { item == 2 && 
         <span className='span-title'>
          <Title level={2} className='header-title'>Mis Proyectos</Title>
          <Text>Mira todos los proyectos que hiciste con Itesa, vamos por mas 💪🏻
          </Text>
        </span>}          
